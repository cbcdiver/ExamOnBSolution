...
enum Operator : String {
    ...
    // Exam: Add Summation to the list of Operators
    case Summation = "∑"
    case Equals = "="
    ...
    var asInt:Int {
        ...
        // Exam: Summation Factorial an Int
        case .Summation: return 8
    ...
    static func from(int index:Int) -> Operator
    {
        ...
        // Exam: Convert an Int back to Summation
        case 8: return .Summation
